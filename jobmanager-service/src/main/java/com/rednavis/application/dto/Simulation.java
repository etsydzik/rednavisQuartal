...
public class Simulation {
    ...
    public boolean equals(Object o) {
        ...
        if (optScenarioId != that.optScenarioId) return false;
        if (tenantId != null ? !tenantId.equals(that.tenantId) : that.tenantId != null) return false;
        if (vertical != null ? !vertical.equals(that.vertical) : that.vertical != null) return false;
    ...
    public String toString() {
        ...
        sb.append(", optScenarioId=").append(optScenarioId);
        sb.append('}');
        return sb.toString();
    }
}