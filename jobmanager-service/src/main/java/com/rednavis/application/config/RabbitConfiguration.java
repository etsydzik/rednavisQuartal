...
import com.rednavis.application.rabbit.converter.ActionType;
import com.rednavis.application.rabbit.exception.CustomExceptionStrategy;
import com.rednavis.application.rabbit.service.AMQPRoutingKeysService;
import com.rednavis.application.rabbit.service.AmqpPropertyService;
import com.rednavis.application.rabbit.status.TaskStatusManager;
import com.rednavis.application.rabbit.status.TaskStatusManagerImpl;
...
public class RabbitConfiguration {
    ...
    public List<Queue> getQueuesByServiceType() {
        ...
        return queuesMap.entrySet().stream().map(Map.Entry::getValue).collect(Collectors.toList());
    }
}
