package com.rednavis.application.rabbit.service;
...
public class AMQPRoutingKeysService {
    ...
    public String routingKeyToListen() {
        return new StringBuilder(routingKey()).append(".*").toString();
    }

    @Bean
    public String controlRoutingKeyToListen() {
        return new StringBuilder(routingKey()).append(".control").append(".*").toString();
    }
