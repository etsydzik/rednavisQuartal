...
public class ExecutorResponse extends ServiceQueueResponse {
    ...
    public ExecutorResponse(String tenantId, String actionType, String message, String processingResult, Integer asynchStatus, Integer solutionStatus, String documentId) {
